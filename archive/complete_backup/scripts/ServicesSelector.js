...
export class ServicesSelector {
   ...
   */
  constructor(options) {
    console.log('[ServicesSelector] Initializing with options:', options);
    ...
    console.log('[ServicesSelector] Container:', this.container);
    console.log('[ServicesSelector] State:', this.state);
    console.log('[ServicesSelector] Config:', this.config);
    ...
    console.log('[ServicesSelector] Initialization complete');
...
console.log('[ServicesSelector] Component exported as ES6 module');
