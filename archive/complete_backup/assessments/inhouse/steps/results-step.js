...
// Import export utilities for download functionality
import * as ExportUtils from '../../../shared/utils/export-utils.js';
...
export class ResultsStep extends StepBase {
    ...
    handleJsonDownload() {
        ...
        try {
            ...
            const exportData = ExportUtils.prepareAssessmentData(this.assessment.state);
            ExportUtils.downloadAsJson(exportData, 'assessment-results.json');
        } catch (error) {
...
console.log('[ResultsStep] Class exported as ES6 module');
