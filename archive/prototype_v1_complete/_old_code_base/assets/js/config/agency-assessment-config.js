 ...
 * 
 * Comprehensive configuration for the agency assessment module of the framework.
 * Adapted from the original configuration for the modular assessment framework.
 */
...
window.AssessmentConfig = AgencyAssessmentConfig;
window.AgencyAssessmentConfig = AgencyAssessmentConfig; // Backward compatibility
...
window.AssessmentFramework.Config.Agency = AgencyAssessmentConfig;
