...
(async function() {
  ...
  try {
          ...
          React.createElement('div', { 
            ...
            item.value && React.createElement('div', { 
              style: { 
                fontSize: '22px', 
                fontWeight: 'bold',
                color: item.type === 'warning' ? '#ff9933' : '#66ff66',
                marginLeft: '15px',
                background: item.type === 'warning' ? 'rgba(255, 153, 51, 0.1)' : 'rgba(102, 255, 102, 0.1)',
                padding: '5px 10px',
                borderRadius: '4px'
              } 
            }, item.value)
    ...
    // Helper functions for impact and effort colors
    function getImpactBackground(impact) {
      switch(impact.toLowerCase()) {
        case 'high': return 'rgba(102, 255, 102, 0.15)';
        case 'medium': return 'rgba(255, 255, 102, 0.15)';
        case 'low': return 'rgba(255, 153, 51, 0.15)';
    ...
    function getEffortBackground(effort) {
      switch(effort.toLowerCase()) {
        case 'low': return 'rgba(102, 255, 102, 0.15)';
        case 'medium': return 'rgba(255, 255, 102, 0.15)';
        case 'high': return 'rgba(255, 77, 77, 0.15)';
        default: return 'rgba(255, 255, 255, 0.1)';
      }
    }
