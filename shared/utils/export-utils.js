...
// Make the ExportUtils namespace available as a global
window.ExportUtils = ExportUtils;

// Log that the export utilities are registered
console.log('[ExportUtils] Export utilities registered as global');
